...
//BOOST_AUTO_TEST_CASE(test_elevation_samplingNE) {
//
//    // Load up a fake route to get some data
//    ElevationData data = ElevationData(glm::vec2(-71.099049,42.372044),
//                                       glm::vec2(-71.012393,42.315662));
//
//    // Sample using regular GDAL data
//    glm::vec3 sample_CPU = data.metersToMetersAndElevation(data.longitudeLatitudeToMeters(glm::dvec2(-71.05888,42.360082)));
//
//    // Generate the program
//    // Get stuff we need to execute a kernel on
//    const boost::compute::context& ctx = Kernel::getContext();
